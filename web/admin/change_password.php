...
if (isset($_POST['submit'])) {
    ...
    $result = change_psw($_POST, 'users', $current_user);
    if ($result === true) {
        $msg = true;
...
if (isset($_POST['reset'])) {
    $msg = true;
    $current_user = $_SESSION['user_id'];
    $result = Reset_password($_POST, 'users', $current_user);
    if ($result === true) {
        $message = true;
                    ...
                    <div class="row no-gutters">
                      ...
                      <div class="col-lg-6 bg-white">
                        ...
                        <?php }?>
                            ...
                            <div class="special_action_confirm"><div id="content1" class="popup-effect"><div class="popup"><div class="letter-w3ls"><form method="post"><h1 class="ebsu">IDEAL UPDATE.</h1><section><p>Are you sure you want to Reset Password?</p></section><div class="btnn"><button class="btn btn-primary bd-0" type="submit" name="reset">Proceed</button><button class="btn btn-primary bd-0">Cancel</button><br></div></form></div></div></div></div>
