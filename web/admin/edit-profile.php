    ...
    <script type="text/javascript">
      ...
      function notifyWithToast(type, message) {
          ...
          setTimeout(function refresh(){
            window.location = 'edit-profile.php?user_id=<?php echo $user_id; ?>';
          }, 1000);
      </script>     
<?php endif; ?>
